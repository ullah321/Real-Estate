...
const Projects = () => {
  ...
  return (
    <motion.div
      ...
      <p className="text-center mx-auto max-w-80 text-gray-500 mb-8">Crafting Spaces, Building Legacies-Explore Our Portfolio</p>
        ...
        <div className="flex gap-8 transition-transform duration-500 ease-in-out" style={{
            ...
            {projectsData.map((project, index) => (
                <div key={index} className="w-full relative flex-shrink-0 sm:w-1/4">
                    <img src={project.image} alt={project.title} className="rounded shadow-md w-full h-auto mb-14" />
                    <div className="absolute left-0 right-0 bottom-5 flex justify-center">
                        <div className="inline-block bg-white w-3/4 py-2 px-4 shadow-md rounded">
